...
[本文]
アプリを開くと新規登録とログインと出てくるので、まずは新規登録をします。登録を終えると、JourneyとAlbum、Settingと表示されるのでJourneyを選択してください。すると、牡羊座やふたご座といった星座名が書かれていると思います。今回は牡羊座とかに座のみ使用できます。そして、牡羊座とかに座のどちらかをタップすると、マップ上に目的地が複数個所現れます。このとき、目的地は選んだ星座の形をしています。ユーザーはマップに表示されている目的地をめぐり、行った先で撮った写真を記録として残しておくことができます。このアプリは
